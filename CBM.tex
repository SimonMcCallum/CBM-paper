...
We have used CBM over many years both in Norway and New Zealand to improve the quality of feedback to students, improve question quality, and emphasise the importance of meta-cognition. We have a three level confidence system where students select their confidence per question:

\begin{table}[h]
\centering
\caption{CBM scoring matrix used in our courses.}
...
These numbers have been carefully chosen based on game theory and student feedback. Although there are many options which are mathematically equivalent or that preserve rank order, there is a difference in the mind of the student answering between this system and the double of the system: 2, 0; 3, $-1$; 4, $-4$. The 2 for a right answer already feels different to 1 for a right answer. 3 for somewhat confident feels proportionally larger than 2 as opposed to 1.5 being greater than 1.0. The idea of a fractional mark increase ``feels'' like partial credit. It also places the somewhat confident mark as a partial confidence. The phrase ``you get an extra half mark, but risk half a mark'' feels more symmetric than larger marks.
